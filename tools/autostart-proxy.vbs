...
' 目标：<仓库目录>\tools\start-pc-model-services.ps1 -ProxyOnly
'
...
' 手动跑一次：双击 <仓库目录>\tools\start-pc-model-services.ps1
Option Explicit
Dim fso, sh, ps, script
Set fso = CreateObject("Scripting.FileSystemObject")
Set sh  = CreateObject("WScript.Shell")
ps = sh.ExpandEnvironmentStrings("%SystemRoot%") & "\System32\WindowsPowerShell\v1.0\powershell.exe"
script = "<仓库目录>\tools\start-pc-model-services.ps1"
